const Home = ({stroke}: {stroke?: string}) => {
  return (
    ...
    >
      <g clipPath="url(#clip0_112_6808)">
        <path
          d="M5.99963 14.6667L5.83254 12.3274C5.74271 11.0697 6.73877 10 7.99963 10C9.26049 10 10.2565 11.0697 10.1667 12.3274L9.99963 14.6667"
          stroke={stroke || "#001735"}
        />
        <path
